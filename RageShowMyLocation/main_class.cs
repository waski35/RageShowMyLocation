...
namespace RageShowMyLocation
{
    public class RageShowMyLocationClass 
    {
        ...
        public static int option_metric = 0;
        public static int option_12hourclock = 0;
        public static int option_rect_aroud_text = 0;
        public static int option_box_opacity = 100;
        public static int option_show_cords = 0;
        public static int option_show_zone = 0;
        public static int option_show_player_speed = 0;
        public static int option_show_time = 0;
        public static int option_show_heading = 0;
        private static string option_menu_key = "F6";
        ...
        private static void PrepareStreet()
        {
            ...
            text_rect_heading = Rage.Graphics.MeasureText(heading, option_font_name, option_font_size_heading);
